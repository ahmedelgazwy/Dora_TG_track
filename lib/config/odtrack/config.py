...
cfg.MODEL.APN.NUM_HEADS = 4
cfg.MODEL.APN.NUM_ENCODER_LAYERS = 2
cfg.MODEL.APN.NUM_DECODER_LAYERS = 1
# TRAIN
cfg.TRAIN = edict()
cfg.TRAIN.LR = 0.0001
...
cfg.TRAIN.PERCEPTUAL_WEIGHT = 0.3
cfg.TRAIN.L1_APPEARANCE_WEIGHT = 0.3
